...
public class JsonFileSystemPersistenceTest {
    ...
    public void shouldSaveStuffInTheRightPlace() throws IOException {
        ...
        JsonFileSystemPersistence<FeedId, Channel> target = new JsonFileSystemPersistence<>(path, "filename", Channel.class);

        target.updateChannel(new FeedId("id"), new Channel(

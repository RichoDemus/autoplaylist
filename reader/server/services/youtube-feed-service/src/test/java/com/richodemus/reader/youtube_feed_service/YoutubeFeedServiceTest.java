...
public class YoutubeFeedServiceTest {
    ...
    public void setUp() {
        ...
        target = new YoutubeFeedService(cache, mock(YoutubeChannelDownloader.class), eventStore);
    }
    ...
    public void shouldReturnEmptyOptionalWhenChannelNotSubscribedTo() {
        ...
        Assertions.assertThat(channel).isNotPresent();
    }
    ...
    public void shouldCacheFeedsReadFromDisk() {
        ...
        final FeedCache cache = new FeedCache(fileSystemPersistence);
        cache.update(CACHED_CHANNEL);
        target = new YoutubeFeedService(cache, mock(YoutubeChannelDownloader.class), new InMemoryEventStore());

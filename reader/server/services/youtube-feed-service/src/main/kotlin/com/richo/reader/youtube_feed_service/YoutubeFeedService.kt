...
internal constructor(
    ...
    fun getVideos(feedId: FeedId) = getVideosTimer.time().use {
        val channel = channelCache[feedId.value] ?: return emptyList<Video>()
        videoCache[channel.playlistId.value]?.videos?: emptyList()
    }

    fun getFeedId(feedUrl: FeedUrl): FeedId = TODO()
